...
*/
// ============================================================================
// TEENSY SD-CARD PATH CONFIGURATION FOR LUA require()
// ============================================================================
#define LUA_VDIR LUA_VERSION_MAJOR "." LUA_VERSION_MINOR// Passen Sie dies an Ihre Lua-Version an (z.B. 5.3 oder 5.4)

// Wir definieren die Pfade so, dass sie direkt auf das Stammverzeichnis 
// und Ihren /lua/-Ordner auf der SD-Karte verweisen.
...
// Da der Teensy keine dynamischen C-Bibliotheken (.dll/.so) zur Laufzeit 
// von der SD-Karte nachladen kann, leeren wir den C-Pfad komplett.
